...
## Introduction
- [What is Base](intro/what-is-base.md)
...
- [Sessions & Cookies](config/sessions-cookies.md)
...
- [CsrfMiddleware](core/csrf-middleware.md)
- [JWT](core/jwt.md)
...
- [Session-Based Authentication](examples/session-auth.md)
